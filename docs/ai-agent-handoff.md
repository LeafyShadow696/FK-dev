...
- `/admin/opportunities` and `/admin/opportunities/refresh` maintain the Opportunity Radar for grants, tenders, market-demand watch sources, and guarded MPSV live-import signals.
